...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .login-sidebar {
                flex: 1;
                background: linear-gradient(rgba(0, 86, 210, 0.7), rgba(0, 86, 210, 0.7)), url('https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&q=80&w=1000');
        ...
        <div class="login-wrapper">
            ...
            <div class="login-form-container">
                ...
                <div class="social-login">
                    <button class="social-btn" onclick="location.href = 'login-google'">
